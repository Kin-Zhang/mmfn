...
from team_code.benchmarks.transfuser.model import TransFuser
from team_code.benchmarks.transfuser.config import GlobalConfig
from team_code.benchmarks.transfuser.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
class TransFuserAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net.load_state_dict(torch.load(os.path.join(self.config_path.model_path, 'best_model.pth'), map_location=torch.device('cpu')))
		self.net.cuda()
		self.net.eval()
