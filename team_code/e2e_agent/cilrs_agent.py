...
from team_code.benchmarks.cilrs.model import CILRS
from team_code.benchmarks.cilrs.data import scale_and_crop_image
from team_code.benchmarks.cilrs.config import GlobalConfig
