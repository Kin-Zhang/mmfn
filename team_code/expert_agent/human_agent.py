...
class HumanAgent(AutonomousAgent):
    ...
    def run_step(self, input_data, timestamp):
        ...
        self.step += 1
        control = self._controller.parse_events(timestamp - self._prev_timestamp, self.step)
...
class KeyboardControl(object):
    ...
    def __init__(self, config_file):
        ...
        self._mode = config_file.mode
        if self.config_file.town is None:
            self.config_file.town = 'TESTING'
        string = pathlib.Path(self.config_file.town).stem + '_' + 'rid' + '_' + str(self.config_file.route_id) +'.json'
        self._endpoint = pathlib.Path(self.config_file.data_save) / string
    ...
    def parse_events(self, timestamp, step):
        """
