...
from .lanes import draw_lane_marking_single_side
...
class MapMaskGenerator:
    ...
    def __init__(
        self, OPmap, pixels_per_meter: int, render_lanes_on_junctions: bool
    ) -> None:
    ...
    def agent_vehicle_mask(self, agent_tf:carla.Transform, bbxy: np.ndarray) -> Mask:
        canvas = self.make_empty_mask()
        bb={'x':bbxy[0], 'y':bbxy[1]}
        corners = [
