...
class AutoPilot(MapAgent):
    ...
    def _get_control(self, pos, target, far_target, tick_data):
    ...
    def run_step(self, input_data, timestamp):
        ...
        steer, throttle, brake, target_speed = self._get_control(pos, near_node, far_node, data)
    ...
    def _should_brake(self):
        ...
        return any(x is not None for x in [vehicle]) # ,walker, light, stop_sign
