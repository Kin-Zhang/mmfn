...
class MMFNPilot(MapAgent):
    ...
    def _get_control(self, pos, target, far_target):
        ...
        if self.config.force_destory_actor and self.stop_counter>self.config.counter_destory:
            self.force_destory_actor(vehicle,light,walker)
    ...
    def _should_brake(self, target, far_target):
        ...
        light = self._affected_by_traffic_light(self._near_object["traffic_light"])
